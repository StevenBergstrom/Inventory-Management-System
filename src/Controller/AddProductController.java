...
public class AddProductController implements Initializable {
    ...
    public void SaveButtonPressed(ActionEvent event) throws IOException{
        ...
        Product product1 = new Product(Integer.parseInt(ID.getText().trim()), Name.getText().trim(), Double.parseDouble(Price.getText().trim()),
    ...
    public void CancelButtonPressed(ActionEvent event) throws IOException{
        ...
        alert.setContentText("Product not added cancel button pressed");
        alert.showAndWait();
    }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ID.setText(Integer.toString(inv.getAllProducts().size() + 1));
        ID.setDisable(true);
